...
export const metadata = {
  title: 'Irrigation Services Rowlett TX | Sprinklers and Lawns',
  description: 'Professional irrigation services in Rowlett, Texas. Sprinkler repair, installation, smart controllers, and seasonal maintenance. Family-owned. License #8146. Call (972) 755-9019.',
...
const services = [
  ...
  { ic:'📅', c:'brown', t:'Seasonal Maintenance',       href:'/seasonal-maintenance',       d:'Scheduled inspections and programming adjustments for year-round Rowlett performance.' },
];
const highlights = [
  'Rowlett is located in Dallas and Rockwall Counties on the eastern edge of the Dallas-Fort Worth metroplex',
  'Rowlett properties include waterfront and inland neighborhoods with varying irrigation requirements',
  'Heavy clay soils throughout Rowlett require zone-specific programming and seasonal adjustments',
  'Rowlett enforces irrigation code compliance including rain and freeze sensors on all systems',
  'Many Rowlett properties near Lake Ray Hubbard require careful irrigation management due to varying sun exposure and plant material',
];
const neighborhoods = ['Waterview','Dalrock Road area','Rowlett Road corridor','Liberty Grove','Miller Road area','Lakeside area','Firewheel border area','Princeton area'];
export default function RowlettPage() {
  return (
    <>
      <section className="page-hero">
        <img src={HERO} alt="Professional irrigation services in Rowlett Texas — sprinkler repair, installation, and maintenance" className="hero-img" />
        ...
        <div className="container" style={{ position:'relative', zIndex:2, padding:'88px 28px' }}>
          <div style={{ maxWidth:'620px' }}>
            <nav style={{ marginBottom:'14px', fontSize:'13px', color:'rgba(255,255,255,.5)' }}>
              ...
              <span style={{ margin:'0 8px' }}>›</span>
              <span style={{ color:'rgba(255,255,255,.9)' }}>Rowlett</span>
            </nav>
            <div className="eyebrow" style={{ color:'var(--green-light)' }}>Rowlett, Texas — Irrigation Services</div>
            <h1 style={{ fontFamily:'var(--serif)', fontSize:'clamp(32px,4.5vw,54px)', fontWeight:400, color:'white', lineHeight:1.1, marginBottom:'18px', marginTop:'8px' }}>
              Irrigation Services in <em style={{ color:'var(--green-light)' }}>Rowlett, Texas</em>
            </h1>
            <p style={{ fontSize:'17px', color:'rgba(255,255,255,.78)', lineHeight:1.76, marginBottom:'32px', maxWidth:'520px' }}>
              Sprinklers and Lawns provides professional irrigation services throughout Rowlett, Texas. Sprinkler repair, installation, smart controllers, and seasonal maintenance for Rowlett homeowners and property managers.
            </p>
            ...
            <div style={{ display:'flex', gap:'20px', marginTop:'24px', flexWrap:'wrap' }}>
              {['Serving Rowlett Since 1980','License #8146','1-Year Warranty'].map(t => (
      ...
      <section className="section bg-white">
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'72px', alignItems:'center' }}>
            <div>
              <span className="eyebrow">Irrigation Services in Rowlett, Texas</span>
              <h2 className="section-title">Professional Irrigation for <em>Rowlett Homeowners and Property Managers</em></h2>
              <div className="divider" />
              <p style={{ color:'var(--text-muted)', marginBottom:'16px', fontSize:'17px' }}>Sprinklers and Lawns has provided irrigation services to Rowlett, Texas homeowners and property managers for over 25 years. Joe Davis earned a Bachelor of Science in Horticulture from Texas A&amp;M in 1989 and brings deep local knowledge to every irrigation project in Rowlett.</p>
              <p style={{ color:'var(--text-muted)', marginBottom:'16px', fontSize:'17px' }}>Whether you need a sprinkler head replaced, a new system installed, or a full irrigation assessment, every job in Rowlett receives the same level of care and attention to detail.</p>
              <div style={{ display:'flex', gap:'14px', flexWrap:'wrap' }}>
                <Link href="/contact" className="btn-primary">Schedule Rowlett Service</Link>
                <a href="tel:9727559019" className="btn-secondary">📞 (972) 755-9019</a>
              </div>
            </div>
            <div className="img-card" style={{ aspectRatio:'4/3' }}><img src={IMG1} alt="Irrigation system maintenance and repair for a Rowlett Texas residential property" /></div>
          </div>
        </div>
      </section>
      <section className="section bg-soft">
        <div className="container">
          <div style={{ textAlign:'center', marginBottom:'52px' }}>
            <span className="eyebrow">Irrigation Services in Rowlett, TX</span>
            <h2 className="section-title">Full Service Irrigation Solutions for <em>Rowlett, Texas</em></h2>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'72px', alignItems:'center' }}>
            <div className="img-card" style={{ aspectRatio:'4/3' }}><img src={IMG2} alt="Irrigation system installation and maintenance serving Rowlett Texas neighborhoods" /></div>
            <div>
              <span className="eyebrow">Serving Rowlett, Texas</span>
              <h2 className="section-title">Local Irrigation Knowledge for <em>Rowlett Properties</em></h2>
              <div className="divider" />
              <p style={{ color:'var(--text-muted)', marginBottom:'20px', fontSize:'17px' }}>Sprinklers and Lawns understands the specific irrigation needs of Rowlett, Texas properties:</p>
              <ul className="check-list" style={{ marginBottom:'28px' }}>{highlights.map(h => <li key={h}>{h}</li>)}</ul>
              <h3 style={{ fontFamily:'var(--sans)', fontSize:'16px', fontWeight:600, color:'var(--text)', marginBottom:'12px' }}>Rowlett neighborhoods and areas we serve:</h3>
      ...
      <section style={{ background:'var(--green)', padding:'52px 0' }}>
        <div className="container">
          <div className="grid-4" style={{ gap:0 }}>
            {[{ n:'25+',l:'Years Serving Rowlett' },{ n:'1980',l:'Established in DFW' },{ n:'#8146',l:'TX Irrigation License' },{ n:'1-Year',l:'Parts & Labor Warranty' }].map((s,i) => (
      ...
      <section className="cta-section">
        <div className="container" style={{ position:'relative', zIndex:2 }}>
          <span className="eyebrow" style={{ color:'var(--green-light)', justifyContent:'center' }}>Schedule Irrigation Service in Rowlett, TX</span>
          <h2 style={{ fontFamily:'var(--serif)', fontSize:'clamp(28px,4vw,44px)', fontWeight:400, color:'white', marginBottom:'16px', marginTop:'8px' }}>
            Serving Rowlett, Texas with Professional <em style={{ color:'var(--green-light)' }}>Irrigation Services Since 1980</em>
          </h2>
          <p style={{ fontSize:'18px', color:'rgba(255,255,255,.72)', maxWidth:'560px', margin:'0 auto 40px', lineHeight:1.76 }}>Call (972) 755-9019 to schedule irrigation service in Rowlett, Texas. Sprinklers and Lawns delivers water-efficient solutions with honest work and clear communication.</p>
