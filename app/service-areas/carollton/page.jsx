...
const highlights = [
  'Carrollton is located in Dallas, Denton, and Collin Counties in the northern Dallas-Ft. Worth area',
  ...
  return (
    <>
      <section className="page-hero">
        <img src={IMG.hero} alt="Professional irrigation services in Carrollton Texas" className="hero-img" />
        ...
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'72px', alignItems:'center' }}>
            <div>
              ...
              <p style={{ color:'var(--text-muted)', marginBottom:'24px', fontSize:'17px' }}>Whether you need a sprinkler head replaced, a new system installed, or a full irrigation assessment, every job in Carrollton receives the same level of care and attention to detail.</p>
              <div style={{ display:'flex', gap:'14px', flexWrap:'wrap' }}>
            ...
            <div className="img-card" style={{ aspectRatio:'4/3' }}><img src={IMG.img1} alt="Irrigation system maintenance in Carrollton Texas" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-white">
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'72px', alignItems:'center' }}>
            <div className="img-card" style={{ aspectRatio:'4/3' }}><img src={IMG.img2} alt="Irrigation installation serving Carrollton Texas neighborhoods" /></div>
            <div>
              ...
              <h3 style={{ fontFamily:'var(--sans)', fontSize:'16px', fontWeight:600, color:'var(--text)', marginBottom:'12px' }}>Carrollton neighborhoods and areas we serve:</h3>
      ...
      <section className="cta-section">
        <div className="container" style={{ position:'relative', zIndex:2 }}>
          ...
          <p style={{ fontSize:'18px', color:'rgba(255,255,255,.72)', maxWidth:'560px', margin:'0 auto 40px', lineHeight:1.76 }}>
            Call (972) 755-9019 to schedule irrigation service in Carrollton, Texas. Sprinklers and Lawns delivers water-efficient solutions with honest work and clear communication.
          </p>
