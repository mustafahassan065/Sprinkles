...
const HERO = '/images/serviceareas/Irving_/iriving (1).jpg';
const IMG1 = '/images/serviceareas/Irving_/iriving (2).jpg';
const IMG2 = '/images/serviceareas/Irving_/iriving (1).jpg';
const services = [
        ...
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'72px', alignItems:'center' }}>
            ...
            <div>
              ...
              <h3 style={{ fontFamily:'var(--sans)', fontSize:'16px', fontWeight:600, color:'var(--text)', marginBottom:'12px' }}>Iriving neighborhoods and areas we serve:</h3>
